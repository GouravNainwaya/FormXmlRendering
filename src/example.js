export const xmlFileSTring =  `<div>
  <div
    id="formSide1"
    class="formSide"
  ...
  >
    <svg
      ...
      id="svgWrap1"
      class="svgWrap ui-draggable ui-draggable-disabled ui-state-disabled"
      width="1122"
      height="1588"
      x="0"
      y="0"
      ...
      >
        ...
        >
          <g
            id="fdtElem3Group"
            fdtType="iso"
            fdtUngroupable="fdtUngroupable"
            fdtSelectable="fdtSelectable"
            fdtFieldName="CustomerName1"
            fdtMandatory="false"
            fdtTabIndex="1"
            fdtVerifyOnHandset="false"
            fdtVerifyOnReview="false"
            fdtSearchableField="false"
            ...
            fdtX="428"
            fdtY="90"
            fdtTypeFormat="Converted"
            delimiterSpace="19"
            fdtResizable="fdtResizable"
          >
            <rect
              id="fdtElem4"
              width="19"
          ...
          <g
            ...
            fdtCapture="true"
            fdtMandatory="false"
            fdtFieldName="Signature4"
            fdtTicked="signed"
            fdtNotTicked="notsigned"
            fdtReviewable="false"
          >
            <rect
              id="fdtElem70"
          ...
          >
            <rect
              id="fdtElem24"
              fdtType="radioListPredefinedDefault"
              fdtSelectable="fdtSelectable"
              fdtRadius="fdtRadius"
              width="24"
              height="24"
          ...
          >
            ...
            >
              <tspan starttag="1">
                <tspan dy="0" dx="0" x="638">
                  <tspan font-size="12pt">
                    <tspan fill="#000000">
                      <tspan font-family="arial">Stage - 1</tspan>
                    </tspan>
                  </tspan>
                </tspan>
              </tspan>
          ...
          >
            <rect
              ...
              fdtActualWidth="25"
              fdtActualHeight="25"
              data-panelOrigID="fdtElem51Group"
              fdtorigstroke="#000000"
            />
            <use
              xlink:href="#radioListImg1"
            ...
            >
              <tspan starttag="1">
                <tspan dy="0" dx="0" x="638">
                  <tspan font-size="12pt">
                    <tspan fill="#000000">
                      <tspan font-family="arial">Stage - 2</tspan>
                    </tspan>
                  </tspan>
                </tspan>
              </tspan>
          ...
          >
            <rect
              ...
              fdtActualWidth="25"
              fdtActualHeight="25"
              data-panelOrigID="fdtElem61Group"
              fdtorigstroke="#000000"
            />
            <use
              xlink:href="#radioListImg1"
